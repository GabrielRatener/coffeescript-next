...
(function() {
  ...
  grammar = {
    ...
    Statement: [
      o('Return'), o('Comment'), o('YieldAll'), o('YieldOn'), o('STATEMENT', function() {
        return new Literal($1);
      })
    ],
    Expression: [o('Await'), o('Value'), o('Invocation'), o('Code'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('Throw'), o('Yield')],
    Block: [
    ...
    YieldAll: [
      o('YIELDALL Expression', function() {
        return new YieldAll($2);
      })
    ],
    YieldOn: [
      o('YIELDON Expression', function() {
        return new YieldOn($2);
      })
    ],
    Comment: [
    ...
    ForSource: [
      ...
      }), o('FORUPON Expression WHEN Expression', function() {
        return {
          source: $2,
          guard: $4,
          stream: true
